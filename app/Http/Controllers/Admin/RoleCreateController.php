...
class RoleCreateController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('admin/role')->with('success', lang('The role was successfully created.', 'alerts'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('admin/role')->with('success', lang('The role has been successfully updated.', 'alerts'));
    }
}
