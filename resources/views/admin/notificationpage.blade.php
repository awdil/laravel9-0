                                                    ...
                                                    @if($notification->read_at != null)
                                                        ...
                                                        <div class="card mb-3 notify-read">
                                                            ...
                                                            <div class="mt-0 text-start">
                                                                    <span class="fs-16 font-weight-semibold">{{Str::limit($notification->data['title'], '50', '...')}} <span class="badge badge-info badge-notify br-13 ms-2 mt-0"> {{lang('Assigned Complaint', 'notification')}} </span></span>
                                                                    <p class="fs-13 mb-0"><strong>{{ $notification->data['ticket_id'] }}</strong> {{lang('Complaint is assigned.', 'notification')}}  <a  href="{{$notification->data['link']}}" data-id="{{$notification->id}}" class="ms-3 text-blue mark-as-read">{{lang('View')}}</a></p>
                                                                </div>
                                                            </div>
                                                ...
                                                @else
                                                    @if($notification->data['status'] == 'New')
                                                        ...
                                                        <div class="card mb-3 notify-read">
                                                            ...
                                                            <div class="">
                                                                ...
                                                                <div class="mt-0 text-start">
                                                                    <span class="fs-16 font-weight-semibold">{{Str::limit($notification->data['title'], '50', '...')}} <span class="badge badge-burnt-orange badge-notify br-13 ms-2 mt-0"> {{lang('New Complaint', 'notification')}} </span></span>
                                                    ...
                                                    @if($notification->data['status'] == 'Closed')
                                                        ...
                                                        <div class="card mb-3 notify-read">
                                                            ...
                                                            <div class="mt-0 text-start">
                                                                    <span class="fs-16 font-weight-semibold">{{Str::limit($notification->data['title'], '50', '...')}} <span class="badge badge-danger badge-notify br-13 ms-2 mt-0"> {{lang('Closed Complaint', 'notification')}} </span></span>
                                                    ...
                                                    @if($notification->data['status'] == 'On-Hold')
                                                        ...
                                                        <div class="card mb-3 notify-read">
                                                            ...
                                                            <div class="mt-0 text-start">
                                                                    <span class="fs-16 font-weight-semibold">{{Str::limit($notification->data['title'], '50', '...')}} <span class="badge badge-warning badge-notify br-13 ms-2 mt-0"> {{lang('On-Hold Complaint', 'notification')}} </span></span>
                                                    ...
                                                    @if($notification->data['status'] == 'Re-Open')
                                                        ...
                                                        <div class="card mb-3 notify-read">
                                                            ...
                                                            <div class="mt-0 text-start">
                                                                    <span class="fs-16 font-weight-semibold">{{Str::limit($notification->data['title'], '50', '...')}} <span class="badge badge-teal badge-notify br-13 ms-2 mt-0"> {{lang('Re-Open Complaint', 'notification')}} </span></span>
                                                    ...
                                                    @if($notification->data['status'] == 'Inprogress')
                                                        @if($notification->data['overduestatus'] == 'Overdue')
                                                            ...
                                                            <div class="card mb-3 notify-read">
                                                                ...
                                                                <div class="mt-0 text-start">
                                                                        <span class="fs-16 font-weight-semibold">{{Str::limit($notification->data['title'], '50', '...')}} <span class="badge badge-danger-light badge-notify br-13 ms-2 mt-0"> {{lang('Overdue Complaint', 'notification')}} </span></span>
                                                        ...
                                                        @else
                                                            ...
                                                            <div class="card mb-3 notify-read">
                                                                ...
                                                                <div class="mt-0 text-start">
                                                                        <span class="fs-16 font-weight-semibold">{{Str::limit($notification->data['title'], '50', '...')}} <span class="badge badge-info badge-notify br-13 ms-2 mt-0"> {{lang('Inprogress Complaint', 'notification')}} </span></span>
