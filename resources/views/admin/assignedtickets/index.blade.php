		...
		@endsection
							...
							<div class="col-xl-12 col-lg-12 col-md-12">
								<div class="row">
									...
									<div class="col">
										<div class="card">
											<a href="{{route('admin.assignedticketinprogressview')}}" class="admintickets"></a>
											<div class="card-body d-flex align-items-center justify-content-between  p-4 px-5">
												<div>
													<p class="fs-13 mb-1 font-weight-semibold">{{lang('In-Progress')}}</p>
													<h4 class="mb-0">{{$assignedticketsinprogress}}
									...
									<div class="col">
										<div class="card">
											<a href="{{route('admin.assignedticketonholdview')}}" class="admintickets"></a>
											<div class="card-body d-flex align-items-center justify-content-between  p-4 px-5">
												<div>
													<p class="fs-13 mb-1 font-weight-semibold">{{lang('On-Hold')}}</p>
													<h4 class="mb-0">{{$assignedticketsonhold}}</h4>
												</div>
												<div class="ticket-state-svg">
									...
									<div class="col">
										<div class="card">
											<a href="{{route('admin.assignedticketreopenview')}}" class="admintickets"></a>
											<div class="card-body d-flex align-items-center justify-content-between  p-4 px-5">
												<div>
													<p class="fs-13 mb-1 font-weight-semibold">{{lang('Re-Open')}}</p>
													<h4 class="mb-0">{{$assignedticketsreopen}}</h4>
												</div>
												<div class="ticket-state-svg">
									...
									<div class="col">
										<div class="card">
											<a href="{{route('admin.assignedticketoverdueview')}}" class="admintickets"></a>
											<div class="card-body d-flex align-items-center justify-content-between  p-4 px-5">
												<div>
													<p class="fs-13 mb-1 font-weight-semibold">{{lang('OverDue')}}</p>
													<h4 class="mb-0">{{$assignedticketsoverdue}}</h4>
												</div>
												<div class="ticket-state-svg">
									...
									<div class="col">
										<div class="card">
											<a href="{{route('admin.assignedticketclosedview')}}" class="admintickets"></a>
											<div class="card-body d-flex align-items-center justify-content-between  p-4 px-5">
												<div>
													<p class="fs-13 mb-1 font-weight-semibold">{{lang('Closed')}}</p>
													<h4 class="mb-0">{{$assignedticketsclosed}}</h4>
												</div>
												<div class="ticket-state-svg">
													<svg xmlns="http://www.w3.org/2000/svg" class="svg-success" viewBox="0 0 24 24"><path d="M10.3125,16.09375a.99676.99676,0,0,1-.707-.293L6.793,12.98828A.99989.99989,0,0,1,8.207,11.57422l2.10547,2.10547L15.793,8.19922A.99989.99989,0,0,1,17.207,9.61328l-6.1875,6.1875A.99676.99676,0,0,1,10.3125,16.09375Z" opacity=".99"/><path opacity="0.2" d="M12,2A10,10,0,1,0,22,12,10.01146,10.01146,0,0,0,12,2Zm5.207,7.61328-6.1875,6.1875a.99963.99963,0,0,1-1.41406,0L6.793,12.98828A.99989.99989,0,0,1,8.207,11.57422l2.10547,2.10547L15.793,8.19922A.99989.99989,0,0,1,17.207,9.61328Z"/></svg>
												</div>
											</div>
										</div>
									</div>
									...
									<div class="card-body" >
										<div class="spruko-delete">
											...
											<div class="table-responsive">
												<table class="table table-bordered border-bottom text-nowrap ticketdeleterow w-100" id="assignedticket">
													<thead >
														<tr >
															<th >{{lang('Sl.No')}}</th>
															@can('Ticket Delete')
