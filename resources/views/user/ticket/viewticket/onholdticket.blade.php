        ...
        <div class="header-text mb-0">
            <div class="container ">
                <div class="row text-white">
                    <div class="col">
                        <h1 class="mb-0">{{lang('On-Hold Complaints', 'menu')}}</h1>
                    </div>
                    <div class="col col-auto">
                        <ol class="breadcrumb text-center">
                            ...
                            <li class="breadcrumb-item active">
                                <a href="#" class="text-white">{{lang('On-Hold Complaints', 'menu')}}</a>
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="col-xl-9">
                    <div class="card mb-0">
                        <div class="card-header border-0">
                            <h4 class="card-title">{{lang('On-Hold Complaints', 'menu')}}</h4>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        <tr {{$onholdticket->replystatus == 'Waiting'? 'class=bg-success-transparent': ''}}>
                                            ...
                                            <td class="removecolumndata">
                                                <input type="checkbox" name="student_checkbox[]" class="checkall" value="{{$onholdticket->id}}" />
                                            </td>
                                            <td class="overflow-hidden ticket-details">
                                                <div class="d-flex align-items-center">
                                                    <div class="">
                                                        <a href="{{route('loadmore.load_data',$onholdticket->ticket_id)}}" class="fs-14 d-block font-weight-semibold">{{$onholdticket->subject}}</a>

                                                        <ul class="fs-13 font-weight-normal d-flex custom-ul">
                                                            <li class="pe-2 text-muted">#{{$onholdticket->ticket_id}}</span>
                                                            <li class="px-2 text-muted" data-bs-toggle="tooltip" data-bs-placement="top" title="{{lang('Date')}}"><i class="fe fe-calendar me-1 fs-14"></i> {{$onholdticket->created_at->timezone(Auth::user()->timezone)->format(setting('date_format'))}}</li>
                                                            ...
                                                            @if($onholdticket->last_reply == null)
                                                                <li class="px-2 text-muted" data-bs-toggle="tooltip" data-bs-placement="top" title="{{lang('Last Replied')}}"><i class="fe fe-clock me-1 fs-14"></i>{{$onholdticket->created_at->diffForHumans()}}</li>

                                                            @else
                                                            <li class="px-2 text-muted" data-bs-toggle="tooltip" data-bs-placement="top" title="{{lang('Last Replied')}}"><i class="fe fe-clock me-1 fs-14"></i>{{$onholdticket->last_reply->diffForHumans()}}</li>
                                            ...
                                            <td>
                                                <div class = "d-flex">
                                                    <a href="{{route('loadmore.load_data',$onholdticket->ticket_id)}}" class="action-btns1" data-bs-toggle="tooltip" data-placement="top" title="{{lang('View Complaint')}}"><i class="feather feather-edit text-primary"></i></a>
                                                    @if(setting('CUSTOMER_RESTICT_TO_DELETE_TICKET') == 'off')
                                                        <a href="javascript:void(0)" class="action-btns1" data-id="{{$onholdticket->id}}" id="show-delete" data-bs-toggle="tooltip" data-placement="top" title="{{lang('Delete Complaint')}}"><i class="feather feather-trash-2 text-danger"></i></a>
                                                    @endif
                                                </div>
                                            </td>
                                        </tr>
